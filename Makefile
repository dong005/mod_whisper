...
# src/mod/asr_tts/mod_whisper/Makefile.  Generated from Makefile.in by configure.
...
subdir = src/mod/asr_tts/mod_whisper
...
am__DEPENDENCIES_1 =
mod_whisper_la_DEPENDENCIES = $(switch_builddir)/libfreeswitch.la \
	$(am__DEPENDENCIES_1)
am__mod_whisper_la_SOURCES_DIST = mod_whisper.c websock_glue.c
am_mod_whisper_la_OBJECTS = mod_whisper_la-mod_whisper.lo \
	mod_whisper_la-websock_glue.lo
mod_whisper_la_OBJECTS = $(am_mod_whisper_la_OBJECTS)
AM_V_lt = $(am__v_lt_$(V))
am__v_lt_ = $(am__v_lt_$(AM_DEFAULT_VERBOSITY))
am__v_lt_0 = --silent
am__v_lt_1 = 
mod_whisper_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC \
	$(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=link $(CCLD) \
	$(mod_whisper_la_CFLAGS) $(CFLAGS) $(mod_whisper_la_LDFLAGS) \
	$(LDFLAGS) -o $@
am_mod_whisper_la_rpath = -rpath \
	$(moddir)
AM_V_P = $(am__v_P_$(V))
...
am__depfiles_remade = ./$(DEPDIR)/mod_whisper_la-mod_whisper.Plo \
	./$(DEPDIR)/mod_whisper_la-websock_glue.Plo
am__mv = mv -f
...
am__v_CCLD_1 = 
SOURCES = $(mod_whisper_la_SOURCES)
DIST_SOURCES = $(am__mod_whisper_la_SOURCES_DIST)
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/build/modmake.rulesam README.md
DISTFILES = $(DIST_COMMON) $(DIST_SOURCES) $(TEXINFOS) $(EXTRA_DIST)
ACLOCAL = ${SHELL} '/usr/src/freeswitch/build/config/missing' aclocal-1.16
AMQP_CFLAGS = 
AMQP_LIBS = 
AMRWB_CFLAGS = 
AMRWB_LIBS = 
...
AUTOMAKE = ${SHELL} '/usr/src/freeswitch/build/config/missing' automake-1.16
...
JAVA_FLAGS = 
JAVA_HOME = 
KS_CFLAGS = -I/usr/include/libks2 
KS_LIBS = -lks2 
...
PACKAGE_STRING = freeswitch 1.10.12-release
PACKAGE_TARNAME = freeswitch
PACKAGE_URL = 
PACKAGE_VERSION = 1.10.12-release
PATH_SEPARATOR = :
PA_LIBS = 
PCAP_CFLAGS = 
PCAP_LIBS = 
...
PCRE_LIBS = -lpcre 
PERL = perl
PERL_CFLAGS = -w -DMULTIPLICITY  -D_REENTRANT -D_GNU_SOURCE -DDEBIAN -fwrapv -fno-strict-aliasing -pipe -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64  -I/usr/lib/x86_64-linux-gnu/perl/5.36/CORE  -DEMBED_PERL
PERL_INC =  -I/usr/lib/x86_64-linux-gnu/perl/5.36/CORE 
PERL_LDFLAGS = -Wl,-E  -fstack-protector-strong -L/usr/local/lib  -L/usr/lib/x86_64-linux-gnu/perl/5.36/CORE -lperl -ldl -lm -lpthread -lc -lcrypt
PERL_LIBDIR = -L/usr/lib/x86_64-linux-gnu/perl/5.36/CORE
PERL_LIBS = -lgdbm -lgdbm_compat -ldb -ldl -lm -lpthread -lc -lcrypt
PERL_SITEDIR = /usr/lib/x86_64-linux-gnu/perl/5.36
...
PYTHON3_CFLAGS = -I/usr/include/python3.11 -I/usr/include/python3.11 -Wsign-compare -DNDEBUG -g -fwrapv -O2 -Wall -g -fstack-protector-strong -Wformat -Werror=format-security -g -fwrapv -O2
PYTHON3_LDFLAGS = -ldl -lm -lpython3.11
...
STIRSHAKEN_LIBS = 
STRIP = strip
SWITCH_AM_CFLAGS = -I/usr/include/uuid  -I/usr/src/freeswitch/src/include -I/usr/src/freeswitch/src/include -I/usr/src/freeswitch/libs/libteletone/src -fPIC -ffast-math -Werror -Wno-unused-result -Wno-misleading-indentation -fvisibility=hidden -DSWITCH_API_VISIBILITY=1 -DCJSON_API_VISIBILITY=1 -DHAVE_VISIBILITY=1 -g -ggdb -DHAVE_OPENSSL
...
SWITCH_AM_CXXFLAGS = -I/usr/src/freeswitch/src/include -I/usr/src/freeswitch/src/include -I/usr/src/freeswitch/libs/libteletone/src -fPIC -ffast-math -fvisibility=hidden -DSWITCH_API_VISIBILITY=1 -DCJSON_API_VISIBILITY=1 -DHAVE_VISIBILITY=1
SWITCH_AM_LDFLAGS = -luuid  -lm
SWITCH_ANSI_CFLAGS =  -Wall -std=c99 -pedantic -Wdeclaration-after-statement
SWITCH_VERSION_MAJOR = 1
SWITCH_VERSION_MICRO = 12-release
...
VERSION = 1.10.12-release
VISIBILITY_FLAG = -fvisibility=hidden
VLC_CFLAGS = 
VLC_LIBS = 
WEBSOCKETS_CFLAGS = 
WEBSOCKETS_LIBS = -lwebsockets -lcap 
WGET = /usr/bin/wget
X264_CFLAGS = 
X264_LIBS = 
XZ = /usr/bin/xz
...
YAML_LIBS = 
ZCAT = /usr/bin/gunzip
abs_builddir = /usr/src/freeswitch/src/mod/asr_tts/mod_whisper
abs_srcdir = /usr/src/freeswitch/src/mod/asr_tts/mod_whisper
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/build/modmake.rulesam $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign src/mod/asr_tts/mod_whisper/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign src/mod/asr_tts/mod_whisper/Makefile
...
mod_whisper.la: $(mod_whisper_la_OBJECTS) $(mod_whisper_la_DEPENDENCIES) $(EXTRA_mod_whisper_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(mod_whisper_la_LINK) $(am_mod_whisper_la_rpath) $(mod_whisper_la_OBJECTS) $(mod_whisper_la_LIBADD) $(LIBS)
...
include ./$(DEPDIR)/mod_whisper_la-mod_whisper.Plo # am--include-marker
include ./$(DEPDIR)/mod_whisper_la-websock_glue.Plo # am--include-marker
...
mod_whisper_la-mod_whisper.lo: mod_whisper.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(mod_whisper_la_CFLAGS) $(CFLAGS) -MT mod_whisper_la-mod_whisper.lo -MD -MP -MF $(DEPDIR)/mod_whisper_la-mod_whisper.Tpo -c -o mod_whisper_la-mod_whisper.lo `test -f 'mod_whisper.c' || echo '$(srcdir)/'`mod_whisper.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/mod_whisper_la-mod_whisper.Tpo $(DEPDIR)/mod_whisper_la-mod_whisper.Plo
#	$(AM_V_CC)source='mod_whisper.c' object='mod_whisper_la-mod_whisper.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(mod_whisper_la_CFLAGS) $(CFLAGS) -c -o mod_whisper_la-mod_whisper.lo `test -f 'mod_whisper.c' || echo '$(srcdir)/'`mod_whisper.c

mod_whisper_la-websock_glue.lo: websock_glue.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(mod_whisper_la_CFLAGS) $(CFLAGS) -MT mod_whisper_la-websock_glue.lo -MD -MP -MF $(DEPDIR)/mod_whisper_la-websock_glue.Tpo -c -o mod_whisper_la-websock_glue.lo `test -f 'websock_glue.c' || echo '$(srcdir)/'`websock_glue.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/mod_whisper_la-websock_glue.Tpo $(DEPDIR)/mod_whisper_la-websock_glue.Plo
#	$(AM_V_CC)source='websock_glue.c' object='mod_whisper_la-websock_glue.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(mod_whisper_la_CFLAGS) $(CFLAGS) -c -o mod_whisper_la-websock_glue.lo `test -f 'websock_glue.c' || echo '$(srcdir)/'`websock_glue.c
...
distclean: distclean-am
		-rm -f ./$(DEPDIR)/mod_whisper_la-mod_whisper.Plo
	-rm -f ./$(DEPDIR)/mod_whisper_la-websock_glue.Plo
	-rm -f Makefile
